...
class TicketsController extends Controller
{
    ...
    {
        abort_if(Gate::denies('ticket_create'), Response::HTTP_FORBIDDEN, 'No está autorizado para realizar esta operación');
    ...
    {
        abort_if(Gate::denies('ticket_edit'), Response::HTTP_FORBIDDEN, 'No está autorizado para realizar esta operación');
    ...
    {
        abort_if(Gate::denies('ticket_delete'), Response::HTTP_FORBIDDEN, 'No está autorizado para realizar esta operación');
    ...
    public function storeComment(Request $request, Ticket $ticket)
    {
        ...
        return redirect()->back()->withStatus('Su comentario ha sido agregado satisfactoriamente');
    }

    public function closeTicket(Request $request, Ticket $ticket)
    {
        abort_if(Gate::denies('ticket_close'), Response::HTTP_FORBIDDEN, 'No está autorizado para realizar esta operación');
        ...
        return redirect()->back()->withStatus('El ticket fue cerrado satisfactoriamente');
    }
